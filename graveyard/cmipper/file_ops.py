...
#         norther = float(match.group("north")) if "-" not in match.group("north") else float(
#             cmipper_utils.dash_process_coordinate(match.group("north")))
#         souther = float(match.group("south")) if "-" not in match.group("south") else float(
#             cmipper_utils.dash_process_coordinate(match.group("south")))
#         wester = float(match.group("west")) if "-" not in match.group("west") else float(
#             cmipper_utils.dash_process_coordinate(match.group("west")))
#         easter = float(match.group("east")) if "-" not in match.group("east") else float(
#             cmipper_utils.dash_process_coordinate(match.group("east")))
