from coralshift.machine_learning.transformer.encoder import (
...
class TSTransformerEncoder(nn.Module):
    ...
    def forward(self, X: Tensor, padding_masks: Tensor) -> Tensor:
        ...
        Args:
            ...
            padding_masks: (batch_size, seq_length) boolean tensor, 1 means keep vector at this position, 0 means
            padding
        Returns:
            output: (batch_size, seq_length, feat_dim)
        """

        # permute because pytorch convention for transformers is [seq_length, batch_size, feat_dim]. padding_masks
        # [batch_size, feat_dim]
        inp = X.permute(1, 0, 2)
