...
def plot_regression_histograms(
    actual: pd.Series, predicted: pd.Series, n_bins: int = 20, presentation_format: bool = False, alpha_scatter = 0.01
):
...
def plot_spatial_inference_comparison(y, predictions, presentation_format: bool = True, extent: tuple[float] = None):
